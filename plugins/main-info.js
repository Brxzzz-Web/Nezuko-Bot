...
conn.reply(m.chat, count === 0 ? 'ꕥ No se encontraron archivos relacionados con tu ID.' : `❀ Se eliminaron ${count} archivos de sesión.`, m)
break
}
case 'script': case 'sc': {
await m.react('🕒')
...
handler.help = ['suggest', 'reporte', 'invite', 'speedtest', 'fixmsg', 'norepoprivadojoe']
handler.tags = ['main']
handler.command = ['suggest', 'sug', 'report', 'reportar', 'invite', 'speedtest', 'stest', 'fixmsg', 'ds', 'norepoprivadojoe', 'norepoprivadojoe']
