...
handler.help = ['suggest', 'reporte', 'invite', 'speedtest', 'fixmsg', 'nodisponible']
handler.tags = ['main']
handler.command = ['suggest', 'sug', 'report', 'reportar', 'invite', 'speedtest', 'stest', 'fixmsg', 'ds', 'nodisponible', 'nodisponible']
